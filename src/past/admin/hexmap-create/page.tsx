...
import CreateBlock from '@ui/admin/hexmapCreate/block'

import PixiCanvas from '@ui/pixi/block'

import UseInitFictiq from './useInitFictiq'
import UseUpdateFictiq from './useUpdateFictiq'
                    ...
                    <Grid gutter={0} style={{ minHeight: '100vh', backgroundColor: '#ffffff' }}>
                        ...
                        <Grid.Col span={4}>
                            <ScrollArea className='h-screen w-full' scrollbars="y">
                                ...
                                <UseInitFictiq></UseInitFictiq>
                                <UseUpdateFictiq></UseUpdateFictiq>
